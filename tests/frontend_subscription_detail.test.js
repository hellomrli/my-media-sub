...
test('episode filters expose missing, pending, ready and recent groups', () => {
  const episodes = [
    {episode: 1, discovered: true, transferred: true, download_status: 'completed'},
    {episode: 2, discovered: true, transferred: false, download_status: 'not_started', recent: true},
    {episode: 3, missing: true},
    {episode: 4, discovered: true, transferred: true, download_status: 'queued'}
  ];
