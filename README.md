...
docker run -d \
  ...
  ghcr.io/hellomrli/my-media-sub:0.9.1
```
...
```bash
curl -LO https://github.com/hellomrli/my-media-sub/releases/download/v0.9.1/my-media-sub-v0.9.1-linux-x86_64.tar.gz
tar -xzf my-media-sub-v0.9.1-linux-x86_64.tar.gz
cd my-media-sub-v0.9.1-linux-x86_64
