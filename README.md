...
docker run -d \
  ...
  ghcr.io/hellomrli/my-media-sub:0.9.9
```
...
```bash
curl -LO https://github.com/hellomrli/my-media-sub/releases/download/v0.9.9/my-media-sub-v0.9.9-linux-x86_64.tar.gz
tar -xzf my-media-sub-v0.9.9-linux-x86_64.tar.gz
cd my-media-sub-v0.9.9-linux-x86_64
