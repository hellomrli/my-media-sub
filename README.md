...
```text
ghcr.io/hellomrli/my-media-sub:1.0.2
```
...
```bash
curl -LO https://github.com/hellomrli/my-media-sub/releases/download/v1.0.2/my-media-sub-v1.0.2-linux-x86_64.tar.gz
curl -LO https://github.com/hellomrli/my-media-sub/releases/download/v1.0.2/my-media-sub-v1.0.2-linux-x86_64.tar.gz.sha256
sha256sum -c my-media-sub-v1.0.2-linux-x86_64.tar.gz.sha256
tar -xzf my-media-sub-v1.0.2-linux-x86_64.tar.gz
cd my-media-sub-v1.0.2-linux-x86_64
...
- Docker 工作流：构建并推送 `v1.0.2`、`1.0.2`、`1.0` 和 SHA 标签镜像。
