(function (root, factory) {
  ...
  function createStore() {
    ...
    tabs: [
      {id: 'dashboard', name: '工作台', description: '待处理事项与更新日历', icon: '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13h8V3H3v10zm10 8h8V11h-8v10zM3 21h8v-6H3v6zm10-12h8V3h-8v6z"/></svg>'},
