(function (root, factory) {
  ...
  function createStore() {
    ...
    settings: {
      ...
      telegram_bot_mode: 'disabled', telegram_bot_allowed_user_ids: [], telegram_bot_allowed_chat_ids: [], telegram_bot_private_only: true,
      telegram_bot_webhook_public_url: '', telegram_bot_webhook_path_secret: '', telegram_bot_webhook_path_secret_configured: false,
      telegram_bot_webhook_secret: '', telegram_bot_webhook_secret_configured: false, bark_url: '', bark_url_configured: false, serverchan_key: '', serverchan_key_configured: false,
